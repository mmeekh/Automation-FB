...
function SettingsToggle({ active = true, label }: { active?: boolean; label: string }) {
  return (
    <button
      type="button"
      className={cn(
          ...
          <Card className="border border-white/70 bg-white">
            <CardHeader className="items-start">
              <div>
                ...
                <p className="text-sm text-neutral-500">AI autopilot coverage across core departments.</p>
              </div>
              <CardBadge className="bg-white text-primary-600 shadow-sm">9 active members</CardBadge>
            </CardHeader>
            <div className="space-y-4 px-6 pb-6">
              {[
                ...
                <div key={item.label} className="rounded-2xl border border-dashed border-primary-200/60 bg-primary-50/30 p-4">
          ...
          <Card className="border border-white/70 bg-white">
            <CardHeader className="items-start">
              <div>
                ...
                <p className="text-sm text-neutral-500">Connect trusted tools and keep your automations in sync.</p>
              </div>
            </CardHeader>
          ...
          <Card className="border border-white/70 bg-white">
            <CardHeader className="items-start">
              <div>
                ...
                <p className="text-sm text-neutral-500">Configure daily guardrails across high-volume AI journeys.</p>
              </div>
            </CardHeader>
            ...
            <div className="space-y-6 px-6 pb-6">
              ...
              <div className="grid gap-5 md:grid-cols-2">
                <div className="rounded-2xl border border-neutral-100 bg-white p-5 shadow-sm">
                  <p className="text-xs font-semibold uppercase tracking-wide text-neutral-400">Reset Interval</p>
                ...
                <div className="rounded-2xl border border-neutral-100 bg-white p-5 shadow-sm">
                  <p className="text-xs font-semibold uppercase tracking-wide text-neutral-400">Error Handling</p>
                  <div className="mt-3 flex flex-wrap gap-2">
          ...
          <Card className="border border-white/70 bg-white">
            <CardHeader className="items-start">
              <div>
                ...
                <p className="text-sm text-neutral-500">Distribute purchased credits across connected Instagram shops.</p>
              </div>
            </CardHeader>
                ...
                {sharedAccounts.map((account) => (
                  <div key={account.handle} className="space-y-2 rounded-2xl border border-white/70 bg-white p-4 shadow-sm">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-sm font-semibold text-neutral-500">{account.credits} credits</span>
                    </div>
        ...
        <section className="grid gap-6 lg:grid-cols-[1.2fr,1fr]">
          <Card className="border border-white/70 bg-white">
            <CardHeader className="items-start">
              <div>
                ...
                <p className="text-sm text-neutral-500">Keep teams in sync when automations shift states.</p>
              </div>
            </CardHeader>
          ...
          <Card className="border border-white/70 bg-white">
            <CardHeader className="items-start">
              ...
              <CardBadge className="bg-white text-primary-600 shadow-sm">Zero trust enforced</CardBadge>
            </CardHeader>
