...
export default function CarWheelsPage() {
  const router = useRouter();

  const handleLaunch = () => {
    router.push('/automations/builder/car-wheels');
  };
      ...
      <main className="min-h-screen bg-gradient-to-b from-neutral-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="lg:order-1">
              <PhoneMockup chatPreview={carWheelsContent.chatPreview} />
            </div>

            {/* Right: Content */}
            <div className="space-y-16 lg:order-2">
              <HeroSection
                hero={carWheelsContent.hero}
                title={carWheelsContent.title}
        ...
        <div className="bg-white py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <FeatureGrid features={carWheelsContent.features} />
          </div>
        </div>
        ...
        <div className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <UseCaseSection useCases={carWheelsContent.useCases} />
          </div>
        </div>
