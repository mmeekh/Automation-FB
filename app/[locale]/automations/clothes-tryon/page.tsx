...
export default function ClothesTryonPage() {
  const router = useRouter();

  const handleLaunch = () => {
    router.push('/automations/builder/clothes-tryon');
  };
      ...
      <main className="min-h-screen bg-gradient-to-b from-neutral-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="lg:order-1">
              <PhoneMockup chatPreview={clothesTryonContent.chatPreview} />
            </div>

            {/* Right: Content */}
            <div className="space-y-16 lg:order-2">
              <HeroSection
                hero={clothesTryonContent.hero}
                title={clothesTryonContent.title}
              ...
              <div className="grid grid-cols-3 gap-6 py-8 border-y border-neutral-200">
                ...
                <div className="text-center">
                  <p className="text-3xl font-bold text-accent-600">%91</p>
        ...
        <div className="bg-white py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <FeatureGrid features={clothesTryonContent.features} />
          </div>
        </div>
        ...
        <div className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <UseCaseSection useCases={clothesTryonContent.useCases} />
          </div>
        </div>
        ...
        <div className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <FAQSection faq={clothesTryonContent.faq} />
          </div>
        </div>
