...
type HairStyleChangePageProps = {
  params: { locale: Locale };
};

export default function HairStyleChangePage({ params }: HairStyleChangePageProps) {
  const launchAutomation = useAutomationLauncher();
  const content = getHairStyleChangeContent(params.locale);
