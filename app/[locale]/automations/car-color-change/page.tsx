      ...
      <main className="min-h-screen bg-gradient-to-b from-neutral-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="lg:order-1">
              <PhoneMockup chatPreview={carColorChangeContent.chatPreview} />
            </div>

            {/* Right: Content */}
            <div className="space-y-16 lg:order-2">
              <HeroSection
                hero={carColorChangeContent.hero}
                title={carColorChangeContent.title}
              ...
              <div className="grid grid-cols-3 gap-6 py-8 border-y border-neutral-200">
                <div className="text-center">
                  ...
                  <p className="text-sm text-neutral-600 mt-1">Renk değişimi</p>
                </div>
                <div className="text-center">
        ...
        <div className="bg-white py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <FeatureGrid features={carColorChangeContent.features} />
          </div>
        </div>
        ...
        <div className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <UseCaseSection useCases={carColorChangeContent.useCases} />
          </div>
        </div>
        ...
        <div className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <FAQSection faq={carColorChangeContent.faq} />
          </div>
        </div>
      </main>
    </>
