...
import { getCarColorChangeContent } from '@/lib/automation-content';
import { useAutomationLauncher } from '@/lib/hooks/useAutomationLauncher';
import type { Locale } from '@/i18n/config';

type CarColorChangePageProps = {
  params: { locale: Locale };
};

export default function CarColorChangePage({ params }: CarColorChangePageProps) {
  const launchAutomation = useAutomationLauncher();
  const content = getCarColorChangeContent(params.locale);
