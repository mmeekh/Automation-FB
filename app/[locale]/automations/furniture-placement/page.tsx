...
type FurniturePlacementPageProps = {
  params: { locale: Locale };
};

export default function FurniturePlacementPage({ params }: FurniturePlacementPageProps) {
  const launchAutomation = useAutomationLauncher();
  const content = getFurniturePlacementContent(params.locale);
