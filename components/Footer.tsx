...
export function Footer() {
  ...
  const aboutLinks = [
    { key: 'aboutUs', href: withLocale('/') },
    { key: 'blog', href: withLocale('/blog') },
    { key: 'pricing', href: withLocale('/pricing') },
  ] as const;

  const legalLinks = [
    { key: 'privacy', href: withLocale('/legal/privacy') },
    { key: 'terms', href: withLocale('/legal/terms') },
    { key: 'deletion', href: withLocale('/legal/data-deletion') },
  ] as const;
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              {socialLinks.map(({ key, href, external, ariaLabel }) => (
                <a
                  key={key}
                  href={href}
